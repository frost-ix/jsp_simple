...
<div class="border-end bg-white" id="sidebar-wrapper">
  <div class="sidebar-heading border-bottom bg-light"><a class="nav-link" href="${pageContext.request.contextPath}../main.jsp">Simple Bank</a></div>
  ...
  <div class="list-group list-group-flush">
    <li class="list-group-item list-group-item-info" style="text-align: center">조회</li>
      <ol class="list-group list-group-numbered">
        ...
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="${pageContext.request.contextPath}../session/MyInfoView.jsp">개인정보 조회</a>
      </ol>
    ...
    <li class="list-group-item list-group-item-info" style="text-align: center">설정</li>
      <ol class="list-group list-group-numbered">
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="${pageContext.request.contextPath}../update/updatePass.jsp">비밀번호 변경</a>
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="${pageContext.request.contextPath}../delete/delAccountForm.jsp">탈퇴</a>
      </ol>
