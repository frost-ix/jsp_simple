...
<form action="createProcess.jsp" method="post" name="Sign">
    ...
    이름 : <input type="text" name="sign_name"><br>
    ID : <input type="text" name="sign_id"><br>
    PW : <input type="password" name="sign_pw"><br>
    계좌 비밀번호 : <input type="password" name="sign_AccntPw"><br>
